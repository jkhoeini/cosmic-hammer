...
* Projects
** PROJ Configuration as Data [5/16]
...
*** Milestone 2: Serializable Config [3/6]
...
**** NOW Refactor rest of the code to use the event/behavior pattern :refactor:
...
*** NOW Create Screen event source :feature:
