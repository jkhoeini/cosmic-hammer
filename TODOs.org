...
* Projects
** PROJ Configuration as Data [0/14]
...
*** Milestone 1: Multiple Instances of the Same Source Type [1/2]
...
*** Milestone 2: Serializable Config [0/4]
Entire automation config can be represented as a single data structure, serialized to a file, and loaded back.

**** LATER [#B] Migrate registry/global APIs to datastructure/local APIs :architecture:
     - Change define-event/behavior/etc to make-event/behavior/etc
     - Return data structures instead of mutating global registries
     - Similar to how hierarchy was refactored (make-hierarchy, derive!)

**** LATER [#B] Explore Clojure Integrant for data-driven config inspiration :architecture:
     - https://github.com/weavejester/integrant

**** LATER [#A] Expand subscription data model                        :architecture:
     ...
     - event-source-selector: which event sources to match
