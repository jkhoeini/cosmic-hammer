...
* Projects
** PROJ Configuration as Data [2/14]
...
**** NEXT Migrate registry/global APIs to datastructure/local APIs :architecture:
...
**** NEXT Explore Clojure Integrant for data-driven config inspiration :architecture:
     - https://github.com/weavejester/integrant

**** NEXT Expand subscription data model :architecture:
