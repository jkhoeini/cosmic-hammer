...
(local menubar-height 25)
(local window-gap (* menubar-height 1.44))

(fn resize-window-to-a4 []
...
(fn move-and-resize-window-left []
  (let [win (hs.window.focusedWindow)
        screen (win:screen)
...
(fn move-and-resize-window-right []
  (let [win (hs.window.focusedWindow)
        screen (win:screen)
